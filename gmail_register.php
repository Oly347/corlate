 ...
 <h2>Complate Your profile</h2>
                            ...
                            <form name="my-form" onsubmit="return validform()" action="user.dml.php" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="full_name" class="form-control" name="full_name" value="<?php echo $_SESSION['givenName'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control" name="email_address"  value="<?php echo $_SESSION['email'] ?>" > 
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="password" class="form-control" name="password" value="<?php echo $_SESSION['password'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                    <img id="blah" src="<?php echo $_SESSION['picture'] ?>" style="box-sizing: content-box; 
  ...
  <input type="file" name="profile_pic" id="profile_pic" onchange="readURL(this);" value="<?php echo $_SESSION['picture'] ?>"/>
</div>
                                </div>
<style>
.upload-btn-wrapper {
