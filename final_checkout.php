...
$cartItemByid = $obj_comp->getUserCartItemByID($_GET['id']);
// echo "<pre>";
// print_r($cartItemByid);
// echo "</pre>";
// exit;
foreach ($cartItemByid as $key => $value) {
...
<body>
    ...
    <form  action="#" method="post" id="employeeForm" >
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="txn_id" id="txn_id" class="form-control" value="<?php echo $txn_id ?>" readonly>
