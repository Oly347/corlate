...
$memoryRow = $obj_comp->getRAMById($_GET['id']);
//exit;


foreach ($memoryRow as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Memory(RAM)</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="memory.upl.php#memory_list" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="memory_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
