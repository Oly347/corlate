...
$monitorRow = $obj_comp->getMonitorById($_GET['id']);
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Monitor</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="monitor.upl.php#monitor" method="post" enctype="multipart/form-data">
