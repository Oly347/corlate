...
?></span>
        ...
        <div class="container-fluid">
          ...
          <div class="container">
  <h2>Order Details</h2>
  <form action="order.upl.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      <label for="c_name">Order Id</label>
      <input type="text" class="form-control" id="order_id" placeholder="Enter Model Name" name="order_id" value="<?php echo $order_id; ?>" readonly>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="username" placeholder="Enter Model Name" name="c_name" value="<?php echo $username; ?>" readonly>

      
    </div>

    <div class="form-group">
      <label for="c_price">Invoice</label>
