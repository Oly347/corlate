...
$hardDriveRow = $obj_comp->getHardDriveById($_GET['id']);
//print_r($motherBoardRow);
//exit;


foreach ($hardDriveRow as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit HardDrive</h1>
  ...
  <form action="hardrive.upl.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="harddrive_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
