...
$rowProductSsd = $obj_comp->getProductSSD($_GET['id']);

//print_r($motherBoardRow);
//exit;


foreach ($rowProductSsd as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit DVD Drive</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="ssd.upl.php#SSD" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="ssd_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
