...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Sound Card</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="sound_card.upl.php#soundCard" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="sound_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
