...
$cpuRow = $obj_comp->getCPUById($_GET['id']);

// print_r($cpuRow);
// exit;


foreach ($cpuRow as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Processor</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="processor.upl.php#processor" method="post" enctype="multipart/form-data">
