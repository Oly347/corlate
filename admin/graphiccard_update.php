...
$graphicCardRow = $obj_comp->getGCARDById($_GET['id']);
//print_r($motherBoardRow);
//exit;


foreach ($graphicCardRow as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Graphic Card</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="graphic.upl.php#graphicList" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="graphic_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
