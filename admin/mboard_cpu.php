...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Product Link</h1>


          <div class="container">
 <!--  --><div class="col-md-6">
  <form action="mboard_cpu.dml.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      <label for="c_processor">Processor</label>
     


           <select name="c_processor" id="c_processor" class="form-control"   value="<?php echo $price; ?>">


           <option value="select"> Processor Select</option>
                   <?php

                   foreach ($rowCPUComponent as  $row_price) {
                       
                   ?>
                    
                   <option value="<?php echo $row_price['id'];?>"><?php echo $row_price['component_name'];?></option>
    ...
    <div class="form-group">
      <label for="c_motherboard">Motherboard</label>
      <select name="c_motherboard" id="c_motherboard" class="form-control"  value="<?php echo $price; ?>">

      <option value="select"> Motherboard Select</option>
                   <?php

                   foreach ($rowMBComponent as  $row_mb) {
                       
                   ?>
                    
                   <option value="<?php echo $row_mb['id'];?>"><?php echo $row_mb['component_name'];?></option>
