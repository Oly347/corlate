...
$smpsRow = $obj_comp->getSMPSById($_GET['id']);
//print_r($motherBoardRow);
//exit;


foreach ($smpsRow as $key => $value) {
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit SMPS</h1>


          <div class="container">
  <h2>Component Details</h2>
  <form action="smps.upl.php#SMPS" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="hidden" name="smps_id"  class="form-control" value="<?php echo $_GET['id']; ?>">
    </div>
